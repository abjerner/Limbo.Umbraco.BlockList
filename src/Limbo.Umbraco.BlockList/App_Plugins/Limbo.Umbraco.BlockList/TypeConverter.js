angular.module("umbraco").controller("Limbo.Umbraco.BlockList.TypeConverter", function ($scope, $http) {
    ...
    $http.get("/umbraco/backoffice/Limbo/BlockList/GetTypeConverters").then(function(r) {
