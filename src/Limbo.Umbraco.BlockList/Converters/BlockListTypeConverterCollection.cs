...
namespace Limbo.Umbraco.BlockList.Converters {
    ...
    public sealed class BlockListTypeConverterCollection : BuilderCollectionBase<IBlockListTypeConverter> {
        ...
        public BlockListTypeConverterCollection(IEnumerable<IBlockListTypeConverter> items) : base(items) {
        ...
        public bool TryGet(string typeName, out IBlockListTypeConverter item) {
